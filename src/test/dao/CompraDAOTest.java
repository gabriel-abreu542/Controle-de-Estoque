...
public class CompraDAOTest {
    ...
    public void setUp() throws SQLException {
        ...
        Produto produto1 = new Produto("P1","Parafuso");
        Produto produto2 = new Produto("P2","Cimento");
        produtoDAO.inserir(produto1);
        produtoDAO.inserir(produto2);

        Compra compra1 = new Compra("Compra1", fornecedor1, "DINHEIRO");
        ItemTransacao i1 = new ItemTransacao(produto1, 10, 20.0f);
        ItemTransacao i2 = new ItemTransacao(produto2, 5, 5.50f);
